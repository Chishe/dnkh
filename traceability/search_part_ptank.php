        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <div class="head_page">search : sub-part (P-TANK)</div>
                    ...
                    <div class="search_page_box">
                        ...
                        <input class="page_button" style="background-color: lightcoral;" type="button" value="P-TANK PART">
                    ...
                    <div class="search-box">
                        ...
                        <select id="columns" name="columns">
                            ...
                            <option value="tube_mat_date">P-TANK Mat. Date</option>
                            <option value="tube_mat_lot">P-TANK Mat. Lot</option>
                            <option value="tube_mat_no">P-TANK Mat. No.</option>
                            <option value="tube_part_no">P-TANK Part No.</option>
                            <option value="tube_pd">P-TANK PD Date</option>
