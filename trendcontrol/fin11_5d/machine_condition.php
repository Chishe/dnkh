...
<html>
    <head>
        ...
        <title>Denso | FIN 11.5D MACHINE CONDITION</title>
...
<script>
    ...
    socket.addEventListener('message', (event) => {
        ...
        var opts = {
            ...
            staticZones: [
                {strokeStyle: "dimgrey", min: 0, max: 0.1}, // Green
                {strokeStyle: "#4bc0c0", min: 0.1, max: 0.9}, // Yellow
                {strokeStyle: "dimgrey", min: 0.9, max: 1}  // Red
            ],
            staticLabels: {
                ...
                labels: [1*(0), 
                        ...
                        3*(1)/5, 
                        4*(1)/5, 
                        1*(1)],  // Print labels at these values
